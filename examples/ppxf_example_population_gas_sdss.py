...
def ppxf_example_population_gas_sdss(tie_balmer, limit_doublets):
    ...
    for i in range(0,1,1):
        dirname='/home/zhaisai/zhaisai/data/stack_file/'+'8081-1902'+'.fits'
        if os.path.exists(dirname):
            print(dirname)
            f_sig=fits.open(dirname)
            t=f_sig[1].data
            if tie_balmer==False and limit_doublets==False:
                dirpic='/home/zhaisai/zhaisai/result/'+'8081-1902'+'.eps'
            elif tie_balmer==True and limit_doublets==True:
                dirpic='/home/zhaisai/zhaisai/result/'+'8081-1902'+'-Balmer.eps'
    
            dirfile='/home/zhaisai/zhaisai/result/'+'8081-1902'+'.txt'
            ...
            #
                ...
                for i in t.columns:
                    j+=1
                if j>=4:
                    flux=np.ma.array(t['col3'],mask=mask1)
